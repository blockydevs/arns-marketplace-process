...
3. **Environment variables**: Check top of the file to deploy if capitalized variables are correct.
...
- **"Required environment variable not found"**: Ensure your `.env` file contains all required variables
- **"Tests failed"**: Fix any test failures before deploying
- **Process doesn't respond**: Verify the process ID and ensure deployment completed successfully
